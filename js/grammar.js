...
var grammar = {
    ...
    {"name": "COND", "symbols": ["DATTR", "_", "EQ", "_", "STR"], "postprocess": function(d) {return [d[2], d[0], d[4]]}},
    {"name": "COND", "symbols": ["DATTR", "_", "COMP", "_", "STR"], "postprocess": function(d) {return [d[2], d[0], d[4]]}},
    {"name": "P", "symbols": [{"literal":"(","pos":116}, "_", "OR", "_", {"literal":")","pos":124}], "postprocess": function(d) {return d[2]}},
    ...
    {"name": "NATTR$string$1", "symbols": [{"literal":"i"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
   ...
   {"name": "SATTR$string$3", "symbols": [{"literal":"t"}, {"literal":"i"}, {"literal":"c"}, {"literal":"k"}, {"literal":"e"}, {"literal":"t"}, {"literal":"_"}, {"literal":"r"}, {"literal":"e"}, {"literal":"f"}, {"literal":"e"}, {"literal":"r"}, {"literal":"e"}, {"literal":"n"}, {"literal":"c"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
   {"name": "SATTR", "symbols": ["SATTR$string$3"], "postprocess": function(d) {return d[0]}},
   {"name": "SATTR$string$4", "symbols": [{"literal":"p"}, {"literal":"r"}, {"literal":"i"}, {"literal":"o"}, {"literal":"r"}, {"literal":"i"}, {"literal":"t"}, {"literal":"y"}], "postprocess": function joiner(d) {return d.join('');}},
   {"name": "SATTR", "symbols": ["SATTR$string$4"], "postprocess": function(d) {return d[0]}},
   {"name": "SATTR$string$5", "symbols": [{"literal":"s"}, {"literal":"t"}, {"literal":"a"}, {"literal":"g"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
   {"name": "SATTR", "symbols": ["SATTR$string$5"], "postprocess": function(d) {return d[0]}},
    {"name": "DATTR$string$1", "symbols": [{"literal":"d"}, {"literal":"u"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "DATTR", "symbols": ["DATTR$string$1"], "postprocess": function(d) {return d[0]}},
    {"name": "DATTR$string$2", "symbols": [{"literal":"r"}, {"literal":"e"}, {"literal":"s"}, {"literal":"o"}, {"literal":"l"}, {"literal":"v"}, {"literal":"e"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "DATTR", "symbols": ["DATTR$string$2"], "postprocess": function(d) {return d[0]}},
   ...
   {"name": "BATTR$string$3", "symbols": [{"literal":"t"}, {"literal":"i"}, {"literal":"c"}, {"literal":"k"}, {"literal":"e"}, {"literal":"t"}, {"literal":"_"}, {"literal":"n"}, {"literal":"e"}, {"literal":"e"}, {"literal":"d"}, {"literal":"e"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
   {"name": "BATTR", "symbols": ["BATTR$string$3"], "postprocess": function(d) {return d[0]}},
    ...
    {"name": "COMP", "symbols": [{"literal":">","pos":258}], "postprocess": function(d) {return d[0]}},
    {"name": "COMP", "symbols": [{"literal":"<","pos":264}], "postprocess": function(d) {return d[0]}},
    {"name": "EQ", "symbols": [{"literal":"=","pos":272}], "postprocess": function(d) {return d[0]}},
    ...
    {"name": "CONT", "symbols": [{"literal":"~","pos":286}], "postprocess": function(d) {return d[0]}},
    {"name": "CONT$string$1", "symbols": [{"literal":"!"}, {"literal":"~"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "CONT", "symbols": ["CONT$string$1"], "postprocess": function(d) {return d[0]}},
    ...
    {"name": "STR$ebnf$1$subexpression$1", "symbols": [/[^"]/]},
    {"name": "STR$ebnf$1$subexpression$1$string$1", "symbols": [{"literal":"\\"}, {"literal":"\""}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "STR$ebnf$1$subexpression$1", "symbols": ["STR$ebnf$1$subexpression$1$string$1"]},
    {"name": "STR$ebnf$1", "symbols": ["STR$ebnf$1$subexpression$1", "STR$ebnf$1"], "postprocess": function arrconcat(d) {return [d[0]].concat(d[1]);}},
    {"name": "STR", "symbols": [{"literal":"\"","pos":309}, "STR$ebnf$1", {"literal":"\"","pos":318}], "postprocess": function(d) {return d[1].join("").replace('\\\"', '"')}},
